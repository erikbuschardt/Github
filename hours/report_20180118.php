...
if ($result3->num_rows > 0) {
	...
	echo "<tr class='hdr'><td>Submitted</td><td>Month</td><td>Activity</td><td>Volunteer</td><td>Hours</td><td>Delete&nbsp;Entry?</td></tr>"; // Header values
	...
	echo "<tr>";
	echo "<td style='width: 20%; word-wrap: break-word; white-space: normal;'>" . $row['TimeStamp'] . "</td><td>" . $row["Month"] . "</td>";
	echo "<td style='width: 20%;font-size: 75%; word-wrap: break-word; white-space: normal;'>" . $row["ActName"] . "</td>";
	echo "<td style='width: 20%;'><strong>" . $row['LastName'] . "</strong>, <!--<br />--><span style='font-size: 75%;'>" . $row['FirstName'] . "</div></td>";
	echo "<td style='width: 20%;'>" . $row["Hours"] . "</td>";
...
echo "<input class='btn' type='submit' name='formDelete' value='DELETE' style='background-color: #A00; color: #DADADA; font-weight: bold;' />";
