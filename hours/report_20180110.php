...
if ($result3->num_rows > 0) {
	...
	echo "<tr>";
	echo "<td style='word-wrap: break-word; white-space: normal;'>" . $row['TimeStamp'] . "</td><td>" . $row["Month"] . "</td>";
	echo "<td style='font-size: 75%; word-wrap: break-word; white-space: normal;'>" . $row["ActName"] . "</td>";
	echo "<td><strong>" . $row['LastName'] . "</strong><!--, --><br /><span style='font-size: 75%;'>" . $row['FirstName'] . "</div></td>";
