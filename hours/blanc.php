...
body { 
	...
	background-image: url('/assets/images/PowellSymphonyHall.jpg');
	background-size: 100%;
...
while( $row = $resultDataBaseTimeStamp -> fetch_assoc() ) {
	echo "Database last updated:<br />" . $row['TimeStamp'] . "<br />";
	// } else { 
	// echo "0 results"; 
} 
}
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div id="bts-ex-3" class="selectpicker" data-clear="true">
                                    ...
                                    <button data-id="prov" type="button" class="btn btn-lg btn-block btn-default dropdown-toggle">
                                        <span class="placeholder">Select One Month<!--Choose an option--></span>
                                        <span class="caret"></span>
                                    </button>
                                    <div class="dropdown-menu">
                                        <ul class="list-unstyled">
                                            <li class="items" data-value="1">THIS MONTH<!--Item 1--></li>
                                            <li class="items selected" data-value="2">PREV MONTH<!--Item 2--></li>
                                            <!--
                                            <li class="items" data-value="3">Item 3</li>
                                            <li class="items" data-value="4">Item 4</li>
                                            <li class="items" data-value="5">Item 5</li>
...
<!--<p>SLECT ACTIVITY (NEW)</p>-->
<div id="bts-ex-5" class="selectpicker" data-clear="true" data-live="true">
                                    <a href="#" class="clear"><span class="fa fa-times"></span><span class="sr-only">Cancel the selection</span></a>
                                    <button data-id="prov" type="button" class="btn btn-lg btn-block btn-default dropdown-toggle">
                                        <span class="placeholder">Select One Activity</span>
										<span class="caret"></span>
                                    </button>
                                    <div class="dropdown-menu">
                                        <div class="live-filtering" data-clear="true" data-autocomplete="true" data-keys="true">
...
style="border: 2px solid #A00; padding: 0px 0px 0px 5px; width: 250px;" />
                                            ...
                                            <div class="list-to-filter">
                                                <ul class="list-unstyled">
                                                    <li class="optgroup">
                                                        <span class="optgroup-header">Current List of Activities<!-- <span class="subtext">Here!</span>--></span>
                                                        <ul class="list-unstyled">
...
$sqlQueryGetActivities = "SELECT * FROM `ACTIVITIES` ORDER BY ActID ASC";

// $sql = "SELECT id, firstname, lastname FROM MyGuests";
$resultGetActivities = $conn3->query($sqlQueryGetActivities);

if ($resultGetActivities->num_rows > 0) {
    // output data of each row

	// echo "<p><!--Select Volunteer:<br />--><select name='formVolunteer'>";
	// echo "<option value='0'>Select One Volunteer<!-- From Below-->...</option>";

    while($rowActivity = $resultGetActivities->fetch_assoc()) {

// echo $rowActivity["ActName"];
	
echo '<li class="filter-item items" data-filter="' . $rowActivity["ActName"] . '" data-value="' . $rowActivity["ActName"] . '" value="' . $rowActivity["ActName"] . '">'. $rowActivity["ActName"] .' </li>';
      ...
      <input id="msg" type="text" class="form-control" name="msg" placeholder="Additional Info">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div id="bts-ex-3" class="selectpicker" data-clear="true">
                                    <a href="#" class="clear"><span class="fa fa-times"></span><span class="sr-only">Cancel the selection</span></a>
                                    <button data-id="prov" type="button" class="btn btn-lg btn-block btn-default dropdown-toggle"><!--textarea-->
                                        <span class="placeholder">Enter Number of Hours</span>
                                        <span class="caret"></span>
                                    </button>
                                    <div class="dropdown-menu">
                                        <ul class="list-unstyled">
                                            <li class="items" data-value="1">NUM HOURS<!--Item 1--></li>
                                            <li class="items" data-value="2"><!--PREV MONTH--><!--Item 2--></li>
                                            <!--
                                            <li class="items" data-value="3">Item 3</li>
                                            <li class="items" data-value="4">Item 4</li>
                                            <li class="items" data-value="5">Item 5</li>
