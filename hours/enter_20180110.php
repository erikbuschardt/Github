...
$conn->close();
	...
	echo "<center><input class='btn' type='submit' name='formSubmit' value='SUBMIT HOURS' style='font-size: 110%; background-color: #A00; color: #DADADA; font-weight: bold; width: 50%;' /></center></form>";
                                            ...
                                            <div class="search-box">
                                                <div class="input-group">
                                                    ...
                                                    Search By Last Name: <input type="text" id="input-bts-ex-5" class="form-control live-search" 
														tabindex="1" style="border: 2px solid #A00; padding: 0px 0px 0px 5px;" />
