...
if ($result3->num_rows > 0) {
	...
	echo "<tr class='hdr'><td>Date/Time Submitted</td><td>Volunteer Number</td><td>Month</td><td>Hours</td><td>Activity</td></tr>"; // Header values
	while($row = $result3->fetch_assoc()) {
		echo "<tr><td>" . $row['TimeStamp'] . " <span style='color: #F00;'>X</span> " . "</td><td>" . $row['VolunteerID'] . "</td><td>" . $row["Month"] . "</td><td>" . $row["Hours"] . "</td><td>" . $row["Activity"] . "</td></tr>";
		// echo 'true';
