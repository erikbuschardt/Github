...
echo "<form action='pdo.php' method='post'>";
	...
	echo "<p><!--Select Month:<br />--><select name='formMonth'><option value='0'>Select One Month<!-- From Below-->...</option>";
...
$conn->close();
	...
	echo "<input class='btn' type='submit' name='formSubmit' value='Submit' style='width: 50%;' /></form>";
